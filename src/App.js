    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick={() => setHomeScore(homeScore + 1)} className="homeButtons__extraPoint">Home PAT</button>
          <button onClick={() => setHomeScore(homeScore + 2)} className="homeButtons__twoPoint">Home 2PT</button>
        </div>
        <div className="awayButtons">
          ...
          <button onClick={() => setAwayScore(awayScore + 1)} className="awayButtons__extraPoint">Away PAT</button>
          <button onClick={() => setAwayScore(awayScore + 2)} className="awayButtons__twoPoint">Away 2PT</button>
        </div>
      </section>
    </div>
  );
